...
REM Exclusions: Use -xr- for simple file matching (no recursion needed)
if "%DEBUG%"=="1" (
    ...
    call "%SEVEN_ZIP_EXE%" a -t7z -m0=lzma2 -mx=9 -mfb=64 -md=32m -ms=on -mhe=on "-p%PASSWORD%" "%CD%\%ARCHIVE_NAME%" * -r -xr-!%ARCHIVE_NAME% -xr-!encrypt_files.bat -xr-!encrypt_files.ps1 -xr-!7z.exe -xr-!7z2501-x64.msi -xr-!7z2501-x64.exe -xr-!7z2501-arm64.exe
) else (
    call "%SEVEN_ZIP_EXE%" a -t7z -m0=lzma2 -mx=9 -mfb=64 -md=32m -ms=on -mhe=on "-p%PASSWORD%" "%CD%\%ARCHIVE_NAME%" * -r -xr-!%ARCHIVE_NAME% -xr-!encrypt_files.bat -xr-!encrypt_files.ps1 -xr-!7z.exe -xr-!7z2501-x64.msi -xr-!7z2501-x64.exe -xr-!7z2501-arm64.exe 2>nul
)
